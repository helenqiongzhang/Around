...
const (
	...
	BUCKET_NAME = "helen-around-bucket"
)
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//check if the file extension is in mediaTypes
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	// range is optional, default 200km but users can customize
	ran := DISTANCE
...
func handlerCluster(w http.ResponseWriter, r *http.Request) {
	...
	//find all face detection value is greater than 0.9
